...
Description:
  Following program computes the decimal value obtained by concatenating binary representations of consecutive integers from 1 to n...

Problem Statement:
  -> Given an integer n...
  -> Convert each number from 1 to n into binary form...
  -> Concate all binary representations in order...
  -> Return the decimal value of the resulting binary number...
  -> Since the value grows very large, return result modulo 10^9 + 7...
...
Core Idea:
  -> Instead of building large strings, construct the number using bit manipulation...
  -> Shift the existing result left to make space for new bits...
  -> Append the next number using bitwise OR...
...
Understanding the Operation:
  -> result << bitLength
       shifts existing bits left...
       creates space for new binary digits...
       equivalent to multiplying by 2^bitLength...

  -> | i
       appends the binary representation of i...
       merges shifted result with new bits...

Binary Concatenation Visualization:
  result = 110
  next i = 3 (11₂)

  shift left by 2 → 11000
  OR with 11      → 11011

  Final → "11011"...

Approach:
  > Iterative Bit Construction:

     i. Initialize result = 0...
     ii. For each number i from 1 to n:
           determine number of bits in i...
           left shift result by bit length...
           append i using bitwise OR...
           apply modulo to prevent overflow...
     iii. Return result...

Bit Length Calculation:
  -> Integer.toBinaryString(i).length()...
  -> gives number of bits required for i...
...
Bit Length Pattern:
  ...
  -> 4–7 → 3 bits...
  -> 8–15 → 4 bits...
  -> powers of two increase bit length...
...
Walkthrough Example: n = 5
  ...
  i = 2 → bits=2
      result = 1<<2 | 2 = 110₂ = 6  → "110"

  i = 3 → bits=2
      result = 6<<2 | 3 = 11011₂ = 27

  i = 4 → bits=3
      result = 27<<3 | 4 = 11011100₂ = 220

  i = 5 → bits=3
      result = 220<<3 | 5 = 11011100101₂ = 1770

  Output: 1770...

Why Use Modulo (10^9 + 7)?
  -> Prevents overflow for large n...
  -> Result grows exponentially in size...
  -> Keeps value within integer range...
  -> Standard prime modulus for programming problems...

Why Avoid String Concatenation?
  -> String size grows rapidly...
  -> Memory inefficient...
  -> Conversion to decimal becomes infeasible...
  -> Bit manipulation is faster and constant space...

Important Observations:
  -> Every time i reaches a power of 2, bit length increases...
  -> Left shifting ensures correct bit placement...
  -> OR operation merges bits without altering previous values...

Edge Cases:
  -> n = 1 → result = 1...
  -> n = 2 → "110" → 6...
  -> Large n handled efficiently via modulo...
  -> Powers of two increase bit length boundary...

Alternative Bit-Length Optimization:
  -> Instead of string conversion:
       bitLength = 32 - Integer.numberOfLeadingZeros(i)...
...
Time and Space Complexity:
  -> Time Complexity: O(n) iterations...
       bit length computation ≈ O(1)...
  -> Space Complexity: O(1) constant space...

Growth Insight:
  -> Total bits generated ≈ n log₂(n)...
  -> Final number becomes extremely large...
  -> Modular arithmetic ensures feasibility...

Applications:
  -> Bit manipulation techniques...
  -> Efficient number construction problems...
  -> Digital encoding & bitstream building...
