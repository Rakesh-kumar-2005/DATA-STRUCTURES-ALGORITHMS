...
Goal:
  -> Given any BST (possibly skewed)...
  -> Rebuild it into a balanced BST...
  -> Keep inorder traversal unchanged...

------------------------------------------------------------
Core Idea:
------------------------------------------------------------

  A BST’s inorder traversal always produces a **sorted sequence**...
  If we:
    1) Extract inorder values into a sorted list...
    2) Build a tree by choosing the middle element as root...
  → We get a height-balanced BST automatically...
...
------------------------------------------------------------
  ...
  -> ArrayList<Integer>:
       Stores inorder traversal (sorted values)...
...
STEP 1: Inorder Traversal...
  -> Traverse BST in inorder (Left → Root → Right)...
  -> Store node values into ArrayList...
  -> Resulting list is sorted...

  Example:
    BST:   1 → 2 → 3 → 4 (right-skewed)
    Inorder list: [1, 2, 3, 4]...
...
STEP 3: Return New Balanced Root...
  -> The constructed tree is:
       • Height-balanced...
       • Still a valid BST...
       • Has same inorder traversal as original...
...
inorder(root, list):
  ...
  -> Collects values in sorted order...

buildTree(list, left, right):
  -> Recursively constructs balanced BST...
  -> Middle element becomes root...
  -> Ensures height balance...

getHeight(root):
  -> Computes height of tree recursively...
  -> Used for validation and testing...

checkBalance(root):
  -> Returns height if subtree is balanced...
  -> Returns -1 if imbalance detected...

isBalanced(root):
  -> Wrapper over checkBalance...
  -> Confirms tree is height-balanced...

------------------------------------------------------------
Example Walkthrough:
------------------------------------------------------------

Input BST (right-skewed):
  1
   \
    2
     \
...
------------------------------------------------------------
  ...
  -> Inorder traversal preserves BST order...
  -> Middle selection evenly distributes nodes...
  -> Recursive splitting guarantees balance...
  -> Same technique used in:
       • Sorted array → BST conversion...
...
------------------------------------------------------------
  ...
  ✓ Height-balanced tree produced...
  ✓ Same inorder traversal as original...
  ✓ Works for skewed, zigzag, and complex trees...

------------------------------------------------------------
Applications:
------------------------------------------------------------

  -> Optimizing BST search performance...
  -> Database indexing...
  -> Converting skewed trees to balanced form...
  -> Interview-standard BST balancing problem...

------------------------------------------------------------
Final Insight:
------------------------------------------------------------

  Balancing a BST is easiest by:
    "Flatten → Sort → Rebuild using mid-point recursion"...

  Simple, clean, and mathematically sound...
