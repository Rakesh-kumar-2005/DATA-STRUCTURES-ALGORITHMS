...
Description:
  ...
  It first merges both arrays into one sorted array...
  Then calculates the median from the merged result...

Problem Definition:
  -> Given two already sorted arrays...
  -> Combine them conceptually into one sorted sequence...
...
Core Approach:
  ...
  -> Step 3: Compute median using parity check...

Method: merge():
  -> Purpose:
       combine two sorted arrays into one sorted array...
  -> Uses two-pointer technique...
  -> Compare elements and pick smaller first...
  -> Copy remaining elements when one array finishes...
...
Two Pointer Logic:
  ...
  -> While both arrays have elements:
       pick smaller and move pointer...
  -> Append leftovers...

Why This Works:
  -> Both arrays already sorted...
  -> Merging preserves order...
  -> Same technique as Merge Sort...

Method: findMedianSortedArrays():
  -> Call merge() to get sorted result...
  -> mid = (length - 1) / 2...
  -> If even length:
       average of mid and mid+1...
  -> If odd length:
       return middle element...

Median Index Logic:
  -> Using (length - 1) / 2 ensures:
       correct middle for odd...
       lower-middle for even...
  -> For even:
       use mid and mid+1...
...
Optimization Note:
  -> This is simple and intuitive approach...
  -> Interview optimal solution exists:
       O(log(min(m,n))) using binary search partition...
...
Key Insight:
  ...
  -> Once sorted:
       median calculation becomes trivial...

When To Use:
  -> Small/medium inputs...
  -> Clarity preferred over complexity...
  -> Teaching / learning merge technique...

Final Verdict:
  -> Clean and easy solution...
  -> Uses merge + median logic...
  -> Linear time...
